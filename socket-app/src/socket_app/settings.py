...
SOCKET_APP_HEALTHCHECK_TIMEOUT_SECONDS = 3.0
LOG_LEVEL = env.str("LOG_LEVEL", default="INFO").upper()
MAX_LOG_BYTES = 1_000_000
MAX_LOG_TRANSFER_BYTES = env.int("MAX_LOG_TRANSFER_BYTES", default=256 * 1024 * 1024)
LOG_TRANSFER_TTL_SECONDS = env.float("LOG_TRANSFER_TTL_SECONDS", default=300.0)
LOG_TRANSFER_DIR = Path(env.str("LOG_TRANSFER_DIR", default="/tmp/socket-app-log-transfers"))
